...
def run_classifier(classifier):
    results_file = open(f"{classifier.__class__.__name__}.csv", "a")
    ...
    """
    labels = ['Chikungunya', 'Dengue', 'Discarded/Inconclusive']
    #labels = [0, 1, 2]
    ...
    # chik -> dengue -> undef
    # precisao -> recall -> f1
    results_file.write(f"{chik_prec}, {chik_rec}, {chik_f1}, {deng_prec}, {deng_rec}, {deng_f1}, {undef_prec}, {undef_rec}, {undef_f1}\n")
    """
