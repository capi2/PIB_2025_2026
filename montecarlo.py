...
def process_dataset(df):
    cols = ['ID_AGRAVO', "DT_NOTIFIC", "SEM_NOT", "NU_ANO", "SG_UF_NOT", "ID_MUNICIP", "ID_REGIONA", "ID_UNIDADE", 
            "DT_SIN_PRI", "SEM_PRI", "SG_UF", 'NU_IDADE_N', 'CS_SEXO', 'CS_GESTANT', 'CS_RACA', 'CS_ESCOL_N',
            "ID_MN_RESI", "ID_RG_RESI", "VOMITO", "LACO", "ID_PAIS", "DT_INVEST", "TPAUTOCTO", "COUFINF", 
            "COPAISINF", "COMUNINF", "DT_ENCERRA", "DT_NASC", 'HEMATOLOG', 'HEPATOPAT', 'RENAL', 'ACIDO_PEPT',
            'AUTO_IMUNE', 'HOSPITALIZ', 'EVOLUCAO',
